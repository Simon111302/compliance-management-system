import type { Compliance, SubmissionFormDefinition } from '../../types'
import { submissionFormDefinitions } from '../../models/compliance.model'
import { evidenceUrl } from '../../services/compliance.service'
...
interface ComplianceSubmissionViewProps {
  compliance: Compliance | null
  onBack: () => void
}

export function ComplianceSubmissionView({
  compliance,
  onBack,
}: ComplianceSubmissionViewProps) {
